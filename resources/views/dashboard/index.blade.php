                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        <div class="thumbnail">
                                            <img src="{{ asset('images/data sekolah/' . $sk->image) }}" alt="Profile Sekolah"
                                                class="image-fluid" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                                <!-- <h4></h4> -->
                        ...
                        <div class="panel panel-scrolling">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        <div class="thumbnail">
                                            <img src="{{ asset('images/data sekolah/' . $kepsek->image) }}"
                                                alt="Sambutan Kepala Sekolah" class="image-fluid" style="width:100%">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-10 col-md-offset-1">
                                            <div class="thumbnail">
                                                <img src="{{ asset('images/post/' . $post->thumbnail()) }}"
                                                    alt="Profile Sekolah" class="image-fluid" style="width:100%">
                                            </div>
                                        </div>
                                    </div>
                                    <h3><a target="_blank"
                                            href="{{ route('site.single.post', $post->slug) }}">{{ $post->title }}</a></h3>
                                </div>
                            </div>
                        </div>
                    @empty
